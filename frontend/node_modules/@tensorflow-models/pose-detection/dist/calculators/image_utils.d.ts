...
export declare function getImageSize(input: PoseDetectorInput): ImageSize;
/**
 ...
 */
export declare function toImageTensor(input: tf.Tensor3D | ImageData | HTMLVideoElement | HTMLImageElement | HTMLCanvasElement): tf.Tensor<tf.Rank.R3>;
/**
 ...
 */
export declare function getProjectiveTransformMatrix(subRect: Rect, imageSize: ImageSize, flipHorizontally: boolean, inputResolution: InputResolution): [number, number, number, number, number, number, number, number];
