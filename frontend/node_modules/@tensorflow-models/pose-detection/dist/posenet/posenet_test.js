...
jasmine_util_1.describeWithFlags('PoseNet', jasmine_util_1.ALL_ENVS, function () {
    var detector;
    var timeout;
    beforeAll(function () {
    ...
    it('estimatePoses with multiple poses does not leak memory', function () { return __awaiter(_this, void 0, void 0, function () {
        var input, beforeTensors;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
