...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_FULL = 'https://tfhub.dev/mediapipe/tfjs-model/blazepose_3d/landmark/full/1';
    var DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_LITE = 'https://tfhub.dev/mediapipe/tfjs-model/blazepose_3d/landmark/lite/1';
    var DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_HEAVY = 'https://tfhub.dev/mediapipe/tfjs-model/blazepose_3d/landmark/heavy/1';
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 4:
                            ...
                            worldLandmarksWithVisibility = calculateScoreCopy(landmarks, worldLandmarks, true);
                            projectedWorldLandmarks = calculateWorldLandmarkProjection(worldLandmarksWithVisibility, poseRect);
                            actualWorldLandmarks = projectedWorldLandmarks.slice(0, BLAZEPOSE_NUM_KEYPOINTS);
                            tf.dispose(landmarkResult);
                            tf.dispose([imageTensor, imageValueShifted]);
                            return [2 /*return*/, {
    ...
    var MOVENET_MULTIPOSE_LIGHTNING_RESOLUTION = 256;
    ...
    var MoveNetDetector = /** @class */ (function () {
        function MoveNetDetector(moveNetModel, config) {
            ...
            if (config.multiPoseMaxDimension) {
                ...
                this.multiPoseMaxDimension = MOVENET_MULTIPOSE_LIGHTNING_RESOLUTION;
            }
