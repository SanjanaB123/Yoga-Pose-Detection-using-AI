...
export declare const DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_FULL = "https://tfhub.dev/mediapipe/tfjs-model/blazepose_3d/landmark/full/1";
export declare const DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_LITE = "https://tfhub.dev/mediapipe/tfjs-model/blazepose_3d/landmark/lite/1";
export declare const DEFAULT_BLAZEPOSE_LANDMARK_MODEL_URL_HEAVY = "https://tfhub.dev/mediapipe/tfjs-model/blazepose_3d/landmark/heavy/1";
...
export declare const BLAZEPOSE_TENSORS_TO_WORLD_LANDMARKS_CONFIG: {
    numLandmarks: number;
    inputImageWidth: number;
    inputImageHeight: number;
};
