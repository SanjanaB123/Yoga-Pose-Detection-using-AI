 ...
 */
export declare function tensorsToLandmarks(landmarkTensor: tf.Tensor2D, config: TensorsToLandmarksConfig, flipHorizontally?: boolean, flipVertically?: boolean): Promise<Keypoint[]>;
