...
# import the tensorflow hub model movenet_thunder
# movenet thunder is preferred over lightning because it supports high accuracy
...
# running the algorithm 3 times over the same image to increase efficiency over the image
